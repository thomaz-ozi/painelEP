...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "acao")) {
  $insertSQL = sprintf("INSERT INTO tbnext_mod_empresa_financeiro_receita_parcelas (id_usuario, id_form_pgto, data_vcto, ativado) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_usuario'], "int"),
                       GetSQLValueString($_POST['id_form_pgto'], "int"),
                       GetSQLValueString($_POST['data_vcto'], "date"),
...
mysql_select_db($database_connection, $connection);
$query_list_acao = sprintf("SELECT * FROM vwnext_mod_empresa_financeiro_receita_parc WHERE id_receitas_parcelas = %s", GetSQLValueString($colname_list_acao, "int"));
      ...
      <td colspan="3" align="center" valign="top">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left"  class="txt"><input name="data_vcto" type="text" class="form-datepicker mask_date" required id="data_vcto" value="<?php echo converte_data($row_list_acao['data_vcto']); ?> ">
            </td>
          ...
          <tr>
            ...
            <td align="left"  class="txt"><input name="parc_valor" type="text" class="form-datepicker mask_date" required id="parc_valor" value="<?php echo converte_data($row_list_acao['parc_valor']); ?> "></td>
  ...
  <script>
    ...
    <tr>
      <td colspan="3" align="center" class="txt-Indece">
        ...
        <input name="Alterar" type="submit" class="txt-Botao-Alterar" id="Alterar" value="Salvar">
      </td>
    </tr>
  </table>
