...
<table width="33%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" valign="top" background="../icons/barra-preta.jpg" bgcolor="#FFFFFF"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0" class="txt-Indece">
      <tr>
        ...
        <td width="13%" ><div align="center"><a href="?<?php echo $usuario_get; ?>conteudo=<?php echo $conteudo_inf; ?>-alt&amp;<?php echo $id_banco; ?>=<?php echo $indece;?>&amp;conteudo=<?php echo $conteudo_imagens; ?>" ><img src="<?php echo "$local_icons"; ?>logoff2-25.png" width="25" height="25" border="0" title=" FECHAR "/></a></div></td>
      </tr>
    </table>      </td>
  </tr>
  <tr>
    <td colspan="2" align="center" valign="top" class="txt"><img src="../../minhas_imagens_produtos/<?php echo $arquivo; ?>" width="110" height="82" class="texto_branco" /><?php echo $mensagem; ?>
    </td>
  </tr>
  <tr>
  ...
  <tr>
   <form method="POST" name="add_foto" id="add_foto"> <td colspan="2" align="center" bgcolor="#FFFFFF" class="txt-Indece">
    ...
    <a href="?<?php echo $usuario_get; ?>conteudo=<?php echo $conteudo_inf; ?>-alt&amp;<?php echo $id_banco; ?>=<?php echo $indece; ?>"><img src="<?php echo "$local_icons"; ?>botao_form_ok.png" width="80" height="22" border="0" /></a>
    </td></form>
    </tr>
