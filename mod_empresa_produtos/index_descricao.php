...
$query_list_acao_descr = "SELECT * FROM tbnext_produtos_descricao WHERE id_produtos = '".$id_produtos."' ORDER BY xNome ASC";
...
$(function(){
 $('#descricaoAdd').click(function(){
	loadsDataAbsoluto('#loadDescricao','../mod_empresa_produtos/descricao_acao_add.php',1);
 });	
 	
});

function descricaoEdit(n){
	loadsDataAbsoluto('#loadDescricao','../mod_empresa_produtos/descricao_acao_alt.php',n);

	}
	
function descricaoDel(n){
	loadsDataAbsoluto('#loadDescricao','../mod_empresa_produtos/descricao_acao_del.php',n);

	}
</script>
<script src="../mod_empresa_produtos/script_descricao.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:-18px;" class="table table-hover" >
  ...
  <?php do { ?>
    <tr>
        ...
        <td align="center">
        <button class="options_action_edit_sec " title=" EDITAR " onClick="descricaoEdit(<?php echo $row_list_acao_descr['id_produtos_descricao']; ?>)"   type="button"> </button>
        <button class="options_action_del_sec" title=" EXCLUIR " onClick="descricaoDel(<?php echo $row_list_acao_descr['id_produtos_descricao']; ?>)" type="button"> </button></td>
