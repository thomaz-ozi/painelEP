...
function addtableDescricao(){
			...
			var id_produtos = $('#loadDescricao_id_produtos').val();
...
function descricaoSalvar(){
  var id_produtos=$('#id_produtos').val();
  var loadDescricao_id_produtos_descricao=$('#saveDescricao #loadDescricao_id_produtos_descricao').val();
  alert(id_produtos);
  ...
  var loadDescricao_descricao = CKEDITOR.instances['loadDescricao_descricaoSave'].getData();
		...
		loadsDataAbsoluto('#loadDescricao','../mod_empresa_produtos/descricao_acao_alt.php','&MM_update=acao&id_produtos_descricao='+loadDescricao_id_produtos_descricao+'&xNome='+loadDescricao_xNome+'&descricao='+loadDescricao_descricao);
		loadsData('#loadDescricaolist','../mod_empresa_produtos/index_descricao.php',id_produtos);

}

function descricaoDelet(){
  var id_produtos=$('#id_produtos').val();
  var loadDescricao_id_produtos_descricao=$('#delDescricao #loadDescricao_id_produtos_descricao').val();
		loadsDataAbsoluto('#loadDescricao','../mod_empresa_produtos/descricao_acao_del.php','&id_produtos_descricao='+loadDescricao_id_produtos_descricao);
		loadsData('#loadDescricaolist','../mod_empresa_produtos/index_descricao.php',id_produtos);
