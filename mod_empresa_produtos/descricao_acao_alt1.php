...
<script src="../sistema/ckeditor/ckeditor.js"></script>
 ...
 <input name="id_produtos_descricao" type="hidden" id="id_produtos_descricao" value="<?php echo $row_list_acao['id_produtos_descricao']; ?>" >
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="titulo">Titulo <span class="required">*</span>           </label>
    <input name="xNome" type="text" required="required" class="form-control col-md-6  col-sm-3 col-xs-12" id="xNome" value="<?php echo $row_list_acao['xNome']; ?>">
 </div>
 <div class="clearfix"></div>
<div class="form-group">	
    <label class="control-label col-md-12" for="first-name">Descrição</label>
    <div class="clearfix"></div>
    <textarea class="form-control"  id="descricao" name="descricao" rows="10" tabindex="1"></textarea>
	<script>
...
<div class="clearfix"></div>
    ...
    <div class="form-group">
      <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
        ...
        <button type="submit" class="btn btn-success" id="saveDescricao" ><i class="fa fa-save"></i> Salvar</button>
        </span>
      </div>
    </div>
