...
$query_list_dim = "SELECT * FROM tbnext_produtos_images_dim ORDER BY posicao ASC";
...
$JQuery(function(){
	$JQuery('#enviar').click(function(){
		$JQuery('#res_carregando').css('display','block');
});
...
<div  class="div_absolute_msn">
 <form action="?conteudo=<?php echo $conteudo_inf; ?>-alt&indice=<?php echo $id_banco_recebe; ?>&<?php echo $id_sistema; ?>=<?php echo $_GET[$id_sistema]; ?>&amp;imagens_edit=<?php echo $imagens_edit; ?>&amp;img_nome=<?php echo $_GET['img_nome']; ?>&imagens_alt=<?php echo $imagens_alt; ?>" method="POST" enctype="multipart/form-data" name="upload" id="upload">
	<br />
<br />
		
  <table width="450" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="383" background="../icons/barra-preta.jpg" bgcolor="#CCCCCC"><div align="center" class="textoTitulo_branco">
        <table width="450" height="24" border="0" cellpadding="0" cellspacing="0" class="txt-Indece">
          <tr>
            ...
            <td width="13%" ><div align="center"><a href="?conteudo=<?php echo $conteudo_inf; ?>-alt&<?php echo $id_sistema; ?>=<?php echo $_GET[$id_sistema]; ?>&<?php echo $row_list_alt['id_imgs']; ?>" ><img src="<?php echo "$local_icons"; ?>fechar-25.png" width="25" height="25" border="0" title=" FECHAR "/></a></div></td>
          </tr>
        </table>
      </div></td>
    </tr>
...
?>
        ...
        <tr>
          <td colspan="2" align="center" class="txt">&nbsp;<div class="loading_barra" id="res_carregando"></div></td>
          </tr>
        <tr>
    ...
    <tr>
      <td class="txt-Indece" ><div align="center">
          ...
          <input name="enviar" type="submit" class="txt-Botao-ADD" id="enviar" value="Enviar"   />
        </div>
      </label></td>
    </tr>
            <tr>
