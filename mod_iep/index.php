...
mysql_select_db($database_connection_user, $connection_user);
echo  $query_list_acao = sprintf("SELECT * FROM tbnext_usuario_perm_empresa WHERE id_usuario = %s", GetSQLValueString($colname_list_acao, "int"));
...
<table width="98%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td colspan="3" align="center" class="txt-indece-titulo"><span class="txt-opcoes">
      ...
      <tr>
        <td width="72" align="center"><img src="../mod_empresa/icons/default.png" width="48" height="42" alt="SITE"></td>
        <td width="228">MODULO  EMPRESA</td>
      </tr>
    </table>
     </td>
  </tr>
  <tr  >
    <td width="20%" align="left" class="txt-opcoes">Usuario
      <input name="res2" type="hidden" id="res2" value="res" /></td>
...
?>
       ...
       <tr>
        ...
        <td align="left" class="txt"><input name="id_perm_status_pess" type="checkbox" id="id_perm_status_pess" value="1" <?php if (!(strcmp($row_list_acao['id_perm_status_pess'],1))) {echo "checked=\"checked\"";} ?>>
 <span> Ativo</span></td>
        <td align="left" class="txt">&nbsp;</td>
        <td align="left" class="txt">&nbsp;</td>
      </tr>
...
?>
      ...
      <tr>
        <td align="left" class="txt-opcoes">Colaboradores</td>
...
?>
   ...
   <tr>
    ...
    <input id="Alterar" class="txt-Botao-voltar" type="button" value="|< Voltar" onclick="javascript:history.back()" name="Alterar">
