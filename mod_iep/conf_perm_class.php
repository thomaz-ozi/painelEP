...
<div class="div_absolute_msn"><br>
    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr class="txt-indece-titulo">
            ...
            <td width="21"><img class="fecharmsn" src="../sistema_aparencia/icons/fechar-25.png" width="25" height="25">
            </td>
        </tr>
        <tr class="txt-indece-titulo">
            <td align="center">
        ...
        <tr class="txt-indece-titulo">
            <td align="center"><input name="id_pesquisa" id="id_pesquisa" type="hidden"
        ...
        <tr>
            <td colspan="2" class="txt">
                <div style="overflow:auto; height:200px;" id="pesquisar_assunto"></div>
            </td>
        </tr>
        <tr class="txt-indece-titulo">
            <td colspan="2">&nbsp;</td>
