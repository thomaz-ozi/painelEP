...
mysql_select_db($database_connection, $connection);
 $query_list_alimentacao = "SELECT SUM(a.valor_total)AS valor_total_soma FROM vwnext_relariotio_manejo_alimentacao a WHERE a.id_animais='".$id_animais."' AND '".$ano."-".$mes."-".$day."'  BETWEEN a.data_inicial AND a.data_final ";
