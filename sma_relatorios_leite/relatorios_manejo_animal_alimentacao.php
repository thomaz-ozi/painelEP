<?php
$relatorio_titulo="RELATÓRIO DE ANIMAL - LEITE v:3.0";
...
mysql_select_db($database_connection, $connection);
$query_relatorio_list_acao = "SELECT   * FROM   vwnext_relariotio_manejo_alimentacao  WHERE $sql_cod_animal   ORDER BY $ordem_colunaSQL $ordemSQL";
...
<table border="0" cellspacing="0" cellpadding="0" class="rel_table">
  <tr class="rel_cabecalho">
    <td colspan="10" class="rel_informacoes" ><?php if($conv==1){ ?>
...
'','toolbar=no,location=no ,menubar=no, status=yes, scrollbars=yes,  resizable=yes, width=1024,height=768')"></div></td>
  ...
  <tr class="rel_titulo">
    <td width="19%" class="coluna_titulo" >MANEJO
    ...
    <td width="11%" class="coluna_titulo" title="PRIMEIRA DATA">DATA
    ...
    <td width="22%" class="coluna_titulo" title="PRIMEIRO PESO">ALIMENTAÇÃO
      <?php	$ordem_coluna_nome='3';
	$queryString_1 = sprintf("&cod_animal=".$_GET['cod_animal']."&ordem_coluna=%d%s", $ordem_coluna_nome, $queryString);?>
      <div class="ordem<?php   switch($ordem_coluna){	case $ordem_coluna_nome:	echo $class; break;	default: echo $class_defaul='';	} ?>" onclick="goToURL('<?php printf("%s?ordem=%d%s", $currentPage,$ordem , $queryString_1); ?>')"></div>
    </td>
    <td width="17%" class="coluna_titulo" title="PRIMEIRO PESO">DATA INICIAL
    ...
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">DATA FINAL<?php	$ordem_coluna_nome='4';
	$queryString_1 = sprintf("&cod_animal=".$_GET['cod_animal']."&ordem_coluna=%d%s", $ordem_coluna_nome, $queryString);?></td>
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">PERIODO/DIAS</td>
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">KILO/ANIMAL</td>
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">CUSTO/ANIMAL</td>
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">C.VALOR-TOTAL</td>
    <td width="31%" class="coluna_titulo" title="PRIMEIRO PESO">CUSTO-TOTAL</td>
  </tr> 
  <?php $l=1;?>
  <?php do { ?>
  <tr class="linha<?php   echo $l;  ?>" >
      ...
      <td class="coluna_conteudo"><?php echo $row_relatorio_list_acao['data']; ?></td>
      <td class="coluna_conteudo"><?php echo $row_relatorio_list_acao['nome_alimentacao']; ?></td>
      ...
      <td class="coluna_conteudo"><?php echo $row_relatorio_list_acao['periodo_total_dias']; ?></td>
      <td class="coluna_conteudo"><?php echo converter_numero_moeda_3($row_relatorio_list_acao['kilo_animal']); ?></td>
      <td class="coluna_conteudo"><?php echo converter_numero_moeda_3($row_relatorio_list_acao['kilo_custo']); ?></td>
      <td class="coluna_conteudo"><?php echo converter_numero_moeda_3($row_relatorio_list_acao['valor_total']); ?></td>
      <td class="coluna_conteudo"><?php echo converter_numero_moeda_3($row_relatorio_list_acao['custo_alimentacao']); ?></td>
    </tr>
  <?php   $l++; if($l>2){   $l=1;}?>
