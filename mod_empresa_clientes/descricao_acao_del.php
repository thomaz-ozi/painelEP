...
if ((isset($_POST['id_clientes_descricao'])) && ($_POST['id_clientes_descricao'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbnext_mod_empresa_clientes_descricao WHERE id_clientes_descricao=%s",
                       GetSQLValueString($_POST['id_clientes_descricao'], "int"));
...
mysql_select_db($database_connection, $connection);
$query_list_acao = sprintf("SELECT * FROM tbnext_mod_empresa_clientes_descricao WHERE id_clientes_descricao = %s", GetSQLValueString($colname_list_acao, "int"));
...
<script src="../sistema/ckeditor/ckeditor.js"></script>
 ...
 <input name="id_clientes_descricao" type="hidden" id="loadDescricao_id_clientes_descricao" value="<?php echo $row_list_acao['id_clientes_descricao']; ?>" >
