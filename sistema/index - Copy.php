        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="?startmod=&conteudo=inicio" class="site_title"><?php  $id_local= $_SESSION['LOCAL']; 
			  include ("../sistema_empresa_local/include_list.php");echo $row_list_acao_empresa_local['razao_social']; ?> </span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					...
					<?php echo $row_perfusuario['tratamento']; ?> <?php echo $row_perfusuario['nome']; ?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="?startmod=usuario&conteudo=uu-alt&id_usuario=<?php echo $row_perfusuario['id_usuario']; ?>">  Perfil</a>
                    </li>
                    <li>
                      <a href="javascript:;">
