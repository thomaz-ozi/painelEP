...
$MM_restrictGoTo = "../sistema/login.php?erro=3";
...
<?php include ("../sistema/index_local.php");?>
<div align="center" <?php echo $cidadeClass;?> >
<span style="display:none;"><?php  include "include_url.php"; ?></span>
<?php echo $cidadeNome;?>
</div>
...
<!-- Icons -->
<link rel="stylesheet" href="http://fontawesome.io/icons/../assets/font-awesome/css/font-awesome.css">
...
<?php //  <body class="nav-md" onLoad="temporizador(),disableEnter()"> ?>
  <body class="nav-md" onLoad="disableEnter()">
    <div class="container body" onMouseMove="temporizadorReinicializar()" onKeyPress="temporizadorReinicializar()">
      <div class="main_container" >
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="../mod_images/logo.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Seja Bem Vindo,</span>
                <h2><?php echo $row_perfusuario['tratamento']; ?> <?php echo $usuario_nome= $row_perfusuario['nome']; ?></h2>
                <span>Tempo: <span id="temporizadorInfo"></span></span>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					...
					<?php echo $row_perfusuario['tratamento']; ?> <?php echo $row_perfusuario['nome']; echo $_SESSION['LOCAL'] ?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="?startmod=usuario&conteudo=uu-alt&id_usuario=<?php echo base64_encode($row_perfusuario['id_usuario']); ?>">Perfil</a>
                    </li>
                    <li>
                    <li><a href="<?php echo $logoutAction ?>"><i class="fa fa-sign-out pull-right"></i> Sair</a>
        ...
        <footer>
          <div class="pull-right">
             <a href="http://www.gruponext.com.br"  target="_blank">GrupoNext</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
