...
<div  class="DivBarraFixed" id="OcultaPesquisaAvancada" style="display:none;" >
    ...
    <select id="PesquisaAvancadaColunas" name="PesquisaAvancadaColunas" style="text-indent:-5px">
      ...
      <option value="telefones" title="Pesquisa todos os Telefones" class="linha1">Telefones</option>
	  <option value="telefones_antigo" title="Pesquisa todos os Telefones" class="linha1">Telefones antigo</option>
