...
<div class="container" id="fonts" data-view="search">
  <div class="row"></div>
  ...
  <div class="row fontawesome-icon-list">
    ...
    <section id="brand">
  <h2 class="page-header">Brand Icons - MARCA</h2>

  <div class="alert alert-warning">
    <h4><i class="fa fa-warning" aria-hidden"true"=""></i> Warning!</h4>
Aparentemente, Adblock Plus pode remover ícones de marca impressionante de fonte com a configuração "Remover Social Media Buttons". Nós não vamos usar hacks para forçá-los a apresentar. Por favor relate um problema com Adblock Plus, se você acredita que este seja um erro. Para contornar isso, você vai precisar modificar o nome da classe ícone sociais
<a href="https://adblockplus.org/en/bugs" class="alert-link">mais informaçoes</a>
