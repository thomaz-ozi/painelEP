...
<table width="658" border="0" cellpadding="0" cellspacing="1" class="texto" align="center">
    ...
    <tr>
      <td valign="top"  class="txt-Indece"><div align="center"><a href="?<?php echo $usuario_get; ?>&amp;conteudo=<?php echo $_GET['conteudo']; ?>&<?php echo $id_sistema; ?>=<?php echo $_GET[$id_sistema]; ?>&"><img src="<?php echo "$local_icons"; ?>botao_form_voltar.png" width="80" height="22" border="0" /></a><a href="?<?php echo $usuario_get; ?>&conteudo=<?php echo $conteudo_inf; ?>"><img src="<?php echo "$local_icons"; ?>botao_form_ok.png" width="80" height="22" border="0" /></a></div></td>
    </tr>
    <tr></tr>
  </table>
