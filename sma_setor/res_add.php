...
<div id="apDiv1" style="position:absolute; left:0px; display:block; top:0px; width:100%;  height: auto; min-height:100%; z-index:1; "> 
 <form action="receitas_acao_excluir_res.php?id=<?php echo $row_list_excluir['id']; ?>&amp;idUsuario=<?php echo $_GET[idUsuario]; ?>" method="POST" name="add_receita" id="add" ><br /><br />
  <table width="658" border="0" cellpadding="0" cellspacing="1" class="texto" align="center">
    ...
    <tr>
      <td valign="top"  class="txt-Indece"><div align="center"><a href="?<?php echo $usuario_get; ?>&amp;conteudo=<?php echo $conteudo_inf; ?>"><img src="<?php echo "$local_icons"; ?>botao_form_ok.png" width="80" height="22" border="0" /></a></div></td>
    </tr>
    <tr></tr>
  </table>
