...
//onClick="loadsDataFormFile('#formMSN','../mod_connections/add_foto.php','#acaoform','GET','POST','../mod_connections/form_dados.php')"
//ATENÇÃO!!!
//INPUT OBRIGATÓRIO 
//<input type="file" id="acaofile">
// formURL   ---->  carrega o arquivo
//formURL2  ---->  carrega o formulario
...
function loadsDataFormFile(formMsn,formURL,formID,formGET,formPOST,formURL2){
		...
		if(vPermitidofile==true){
			...
			$(formID+' input[type=file]').simpleUpload(formURL+'?formGET='+formGET, {
