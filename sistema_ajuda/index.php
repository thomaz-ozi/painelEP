...
if(empty($opcao)){
	 $list_SQL="SELECT * FROM tbnext_sistema_ajuda WHERE  ". $and_sql." ORDER BY xNome ASC";
		}else{
 		$list_SQL="SELECT * FROM tbnext_sistema_ajuda WHERE  ". $and_sql ." AND ". $opcao ." LIKE '%".$palavra_pesquisa."%' ORDER BY ".$opcao." ASC";
		}
...
$query_list_class = "SELECT * FROM tbnext_sistema_ajuda_classe01 ORDER BY xNome ASC";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="texto">
  <tr>
    <td colspan="3" align="center" valign="top"  bgcolor="#FFFFFF"  class="txt-indece-titulo"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
  ...
  <tr>
    <td colspan="3" align="center" valign="top"  bgcolor="#FFFFFF"  class="txt"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td  align="left"><a href="?startmod=textos_class01<?php echo $usuario_get; ?>&amp;conteudo=t_class01&amp;<?php echo $id_sistema; ?>=<?php echo $row_list_acao[$id_sistema]; ?>">Editar Classe</a> &nbsp;&nbsp; </td>
      ...
      <select name="id_classe01" id="id_classe01">
        <option value="" <?php if (!(strcmp("", $_GET['id_classe01']))) {echo "selected=\"selected\"";} ?>>---</option>
        <?php
do {  
?>
        <option value="<?php echo $row_list_class['id_classe01']?>"<?php if (!(strcmp($row_list_class['id_classe01'], $_GET['id_classe01']))) {echo "selected=\"selected\"";} ?>><?php echo $row_list_class['xNome']?></option>
        <?php
...
<input type="submit" name="button" id="button" value="Pesquisar" class="txt-Botao-pesquisar"/>
  ...
  <tr>
    <td width="288" align="left" bgcolor="#FFFFFF" class="txt-Indece">Bot&atilde;o da Pagina</td>
    <td width="464" align="left" bgcolor="#FFFFFF" class="txt-Indece">Classe</td>
    <td width="94" align="center"  class="txt">
      <?php if ($row_perfusuario['id_perm_status_usuario_ajuda']==1){?>
      <button type="button" 
    ...
    <td align="center" >
     ...
     <button type="button" 
      ...
      <?php } ?>  
            ...
            <a href="?<?php echo $id_sistema; ?>=<?php echo $row_list_acao[$id_sistema]; ?>&amp;conteudo=<?php echo "$conteudo_inf"; ?>-ver" >
  <div class="options_action_view" title=" VER "></div>
  ...
  <?php  }else{ ?>
  <tr >
    <td colspan="3" align="center" class="txt" ><p><br />
  ...
  <?php } ?>
  <tr>
    <td colspan="3" align="center" class="txt-Indece"><table border="0">
        <tr>
  ...
  <tr>
    <td colspan="3" align="center"><input name="Alterar" type="button" onClick="javascript:history.back()" class="txt-Botao-voltar" id="Alterar" value="|&lt; Voltar" /></td>
  </tr>
</table>
<?php
