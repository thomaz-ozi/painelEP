...
if ((isset($_GET["MM_update"])) && ($_GET["MM_update"] == "acao")) {
  $updateSQL = sprintf("UPDATE $nome_banco SET $imagem_full=%s, $largura_full=%s, $altura_full=%s, $nome_dimencao_full=%s WHERE $id_banco=%s",
                       GetSQLValueString($_GET[$imagem_full], "text"),
                       GetSQLValueString($_GET[$largura_full], "text"),
                       GetSQLValueString($_GET[$altura_full], "text"),
                       GetSQLValueString($_GET[$nome_dimencao_full], "text"),
                       GetSQLValueString($_GET[$id_banco], "int"));
...
<table width="33%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" valign="top" background="<?php echo "$local_icons"; ?>barra-preta.jpg" bgcolor="#FFFFFF"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0" class="txt-Indece">
      <tr>
        ...
        <td width="13%" ><div align="center"><a href="?usuario=<?php echo $_GET['usuario']; ?>&amp;id_imgs=<?php echo $_GET['id_imgs']; ?>&amp;conteudo=imagens-alt" ><img src="<?php echo "$local_icons"; ?>logoff2-25.png" width="25" height="25" border="0" title=" FECHAR "/></a></div></td>
      </tr>
    </table>      </td>
  </tr>
  <tr>
...
<input type="hidden" name="res"  id="res" value="res" /><a href="?usuario=<?php echo $_GET['usuario']; ?>&amp;conteudo=<?php echo $conteudo_imagens; ?>&amp;<?php echo $id_banco; ?>=<?php echo $id_banco_recebe; ?>" ><img src="<?php echo "$local_icons"; ?>botao_form_ok.png" width="80" height="22" border="0" /></a>
