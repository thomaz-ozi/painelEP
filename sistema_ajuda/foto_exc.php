...
<table width="33%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" valign="top" background="../icons/circulo_red/barra-preta.jpg" bgcolor="#FFFFFF"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0" class="txt-Indece">
      <tr>
        ...
        <td width="13%" ><div align="center"><a href="?usuario=<?php echo $_GET['usuario']; ?>&amp;conteudo=<?php echo $conteudo_imagens; ?>&amp;<?php echo $id_banco; ?>=<?php echo $id_banco_recebe; ?>" ><img src="<?php echo "$local_icons"; ?>logoff2-25.png" width="25" height="25" border="0" title=" FECHAR "/></a></div></td>
      </tr>
    </table>      </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF" class="txt-Indece">
    <form method="POST" name="add_foto" id="add_foto">
		<a href="?usuario=<?php echo $_GET['usuario']; ?>&amp;conteudo=<?php echo $conteudo_imagens; ?>&amp;<?php echo $id_banco; ?>=<?php echo $id_banco_recebe; ?>">
        <img src="<?php echo "$local_icons"; ?>botao_form_fechar.png" width="80" height="22" border="0" /></a>

        <a href="?usuario=<?php echo $_GET['usuario']; ?>&amp;conteudo=<?php echo $conteudo_imagens; ?>&amp;<?php echo $id_banco; ?>=<?php echo $id_banco_recebe; ?>&amp;imagens_edit=<?php echo $imagens_edit; ?>&amp;img_nome=<?php echo $_GET['img_nome']; ?>&MM_update=acao">
