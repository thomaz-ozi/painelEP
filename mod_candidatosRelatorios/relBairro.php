...
$query_list_acao = "SELECT * FROM tbMod_canditados  ORDER BY Bairro ASC";
...
$(function(){
 $('#LoadRelatorios').click(function(){
	loadsData('#loadDiv','../mod_candidatosRelatorios/relBairro_load.php');
 });
...
'','toolbar=yes,location=yes ,menubar=yes, status=yes, scrollbars=yes,  resizable=yes, width=1024,height=768')
  ...
  $('#LoadRelatoriosXLS').click(function(){
	MM_openBrWindow('../mod_candidatosRelatorios/relNome_load.php?converter=xls',
'','toolbar=yes,location=yes ,menubar=yes, status=yes, scrollbars=yes,  resizable=yes, width=1024,height=768')
 });	
...
Quantidade de Registro: <?php echo $totalRows_list_acao; ?>
    ...
    <tr>
      ...
      <div class="btn-group">
          ...
          <button class="btn btn-default" type="button" id="LoadRelatoriosXLS"><i class="fa fa-file-excel-o"></i> Relatório como Excel</button>
          </div>
     	</td>
    </tr>
  </tbody>
