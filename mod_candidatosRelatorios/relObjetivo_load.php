...
$list_qtdd='10000';
 	 	...
 	 	$list_SQL="SELECT * FROM tbMod_canditados WHERE Objetivo='".$_GET['opcao']."' ORDER BY Objetivo ASC";;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      <td colspan="4" align="center"><h2>Relatório do Objetivo - <?php  echo $_GET['opcao']; ?></h2><br>
